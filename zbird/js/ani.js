...
step1Nextbtn.click(function(){
  //step1.visible=false
  //step2.visible=true
  typeof _hmt !== "undefined" && _hmt !== null && _hmt.push(['_trackEvent', "zbird", nowStep, "nextBtn", "-"]);
  ifcanupdown=0
  nowStep++
  setStep()
})
step1Backbtn.click(function(){
  //step1.visible=false
  //step2.visible=true
  typeof _hmt !== "undefined" && _hmt !== null && _hmt.push(['_trackEvent', "zbird", nowStep, "backBtn", "-"]);
  ifcanupdown=0
  nowStep--
  setStep()
})
...
var endBtn
$("#pngHolder")[0].addEventListener('touchstart',showScreenHint,false)
...
function goStep4(){
  ...
  if(mode==1){
    endBtn=$("#endBtn111")
    console.log("endBtn===endBtn1")
  }else{
    endBtn=$("#endBtn222")
    console.log("endBtn===endBtn2")
  }
  TweenLite.set(step1Nextbtn,{display:"none"})
  TweenLite.set(step1Backbtn,{display:"none"})
  TweenLite.set(step1Lbtn,{display:"none"})
