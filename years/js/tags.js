...
this.ShowInfo = function(info) {
  return function() {
    ...
    self.tags.slider.updateList("http://image.giccoo.com/projects/years/moreimg/" + self.popContent.code + "-1.jpg,http://image.giccoo.com/projects/years/moreimg/" + self.popContent.code + "-2.jpg,http://image.giccoo.com/projects/years/moreimg/" + self.popContent.code + "-3.jpg");
    return self.update();
  };
};
