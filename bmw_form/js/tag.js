...
riot.tag('register', 
    '<form onsubmit="{submit}" class="form">         <div class="form-grounp">             <label for="sex">称谓*</label>             <div class="select">             <select id="sex" name="sex">                  <option value="male">先生</option>                  <option value="female">女士</option>              </select>             </div>        </div>         <div class="form-grounp">             <label for="username1">姓*</label> <input id="username1" type="text" name="username1">         </div>          <div class="form-grounp">             <label for="username2">名*</label> <input id="username2" type="text" name="username2">         </div>          <div class="form-grounp">             <label for="mobile">移动电话*</label> <input id="mobile" type="text" name="mobile">         </div>         <div class="form-grounp">            <label for="city">报名活动站点</label>             <div class="select">             <select id="city" name="city">          <option value="未选择">请选择</option>        <option value="厦门">厦门 6/18-6/19</option>                  <option value="成都">成都 6/19-6/20</option>                  <option value="武汉">武汉 6/26-6/27</option>                  <option value="广州">广州 6/30-7/3</option>                  <option value="杭州">杭州 7/2-7/3</option>                  <option value="贵阳">贵阳 7/9-7/10</option>                  <option value="济南">济南 7/9-7/10</option>                  <option value="昆明">昆明 7/16-7/17</option>                  <option value="北京">北京 7/23-7/24</option>                  <option value="上海">上海 8/5-8/6</option>                  <option value="重庆">重庆 8/6-8/7</option>                  <option value="合肥">合肥 8/13-8/14</option>                  <option value="西安">西安 8/13-8/14</option>              </select>             </div>        </div>         <div class="endText"><input type="checkbox" id="ckb1"><label for="ckb1"> 我已阅读并接受个人信息保护</label><a href="http://www.bmw.com.cn/cn_mobi/zh/general/legal-notes/index.html">法律声明</a>*</div>         <div class="form-btn">             <button type="submit" class="submit"><img src="img/submit.png"></button>         </div> '
    , function(opts) {
    var self = this
