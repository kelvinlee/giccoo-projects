...
(function e(b, g, d) {
    ...
    , {
        "./shared/getEventType": 2,
        "./utils/addEventListener": 3
    }],
    2: [function(c, f, b) {
    ...
    , {
        "@marcom/ac-prefixer/getEventType": 101
    }],
    3: [function(b, c, a) {
    ...
    , {
        ...
        "@marcom/ac-dom-nodes/ELEMENT_NODE": 7,
        "@marcom/ac-dom-nodes/TEXT_NODE": 8,
        "@marcom/ac-dom-nodes/isNode": 13,
    ...
    , {
        "./internal/validate": 15,
        "./shims/querySelectorAll": 17,
        "@marcom/ac-polyfills/Array/prototype.slice": 74
    }],
    17: [function(c, b, f) {
    ...
    , {
        "@marcom/ac-dom-nodes/isDocumentFragment": 11,
        "@marcom/ac-dom-nodes/isElement": 12,
        "@marcom/ac-dom-nodes/remove": 14,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 69
    }],
    18: [function(b, c, a) {
        c.exports = {
    ...
    , {
        "./touchAvailable": 29,
        "@marcom/ac-function/once": 32,
        "@marcom/ac-useragent": 119
    }],
    21: [function(c, d, b) {
    ...
    , {
        "@marcom/ac-function/memoize": 31,
        "@marcom/ac-prefixer/getStyleProperty": 102,
        "@marcom/ac-prefixer/getStyleValue": 103
    }],
    22: [function(b, c, a) {
        c.exports = {
            getWindow: function() {
    ...
    , {}],
    33: [function(d, f, c) {
        var b = d("@marcom/ac-feature/webGLAvailable");
        var a = d("./defaults");
        function g() {}
        var h = g.prototype;
        h.BLACKLISTED = 1;
        ...
        h.NOT_FOUND = 8;
        h.NO_WEBGL = 16;
        h.getGPUClass = function(j) {
            var i;
            var k = this._extendLists(j);
            if (b()) {
                i = this.getGPU();
                if (i !== null ) {
                    if (this._matchesList(i, k.whitelist)) {
                        return this.WHITELISTED
                    } else {
                        if (this._matchesList(i, k.blacklist)) {
        ...
        h.getGPU = function() {
            ...
            j = i.getContext("webgl") || i.getContext("experimental-webgl") || i.getContext("moz-webgl");
            if (j) {
                k = j.getExtension("WEBGL_debug_renderer_info");
                if (k !== null ) {
                    return j.getParameter(k.UNMASKED_RENDERER_WEBGL)
                }
                return j.getParameter(j.VERSION)
            }
            return null
        }
        ;
        h._matchesList = function(k, l) {
            var j;
            for (j = 0; j < l.length; j++) {
                if (this._matchesEntry(k, l[j])) {
                    return true
                }
            }
            return false
        ...
        ;
        h._matchesEntry = function(l, n) {
            var o = l.toLowerCase();
            var j = n.toLowerCase().split(" ");
            var m = true;
            var k;
        ...
        ;
        h._extendLists = function(k) {
            var j;
            var l = JSON.parse(JSON.stringify(a));
            if (k !== undefined) {
                if (k.blacklist !== undefined && k.blacklist.length > 0) {
                    for (j = 0; j < k.blacklist.length; j++) {
                        l.blacklist.push(k.blacklist[j])
                    }
                }
                if (k.whitelist !== undefined && k.whitelist.length > 0) {
                    for (j = 0; j < k.whitelist.length; j++) {
                        l.whitelist.push(k.whitelist[j])
                    }
                }
            }
            return l
    ...
    , {
        "./defaults": 34,
        "@marcom/ac-feature/webGLAvailable": 30
    }],
    34: [function(b, c, a) {
        c.exports = {
    ...
    , {
        "./data": 39,
        "@marcom/ac-polyfills/Array/prototype.filter": 67,
        "@marcom/ac-polyfills/Array/prototype.some": 75
    }],
    38: [function(b, c, a) {
        c.exports = {
    ...
    , {
        "./className/add": 41,
        "@marcom/ac-polyfills/Array/prototype.slice": 74,
        "@marcom/ac-polyfills/Element/prototype.classList": 82
    }],
    41: [function(b, c, a) {
        var d = b("./contains");
        c.exports = function f(h, g) {
    ...
    , {
        "@marcom/ac-classlist/add": 40,
        "@marcom/ac-classlist/remove": 45,
        "@marcom/ac-object/extend": 51
    }],
    47: [function(c, b, d) {
    ...
    , {
        "@marcom/ac-browser": 36,
        "@marcom/ac-feature/svgAvailable": 27,
    ...
    , {
        "./Array/isArray": 65,
        "./Array/prototype.every": 66,
        "./Array/prototype.filter": 67,
        "./Array/prototype.forEach": 68,
        "./Array/prototype.indexOf": 69,
        "./Array/prototype.lastIndexOf": 70,
        "./Array/prototype.map": 71,
        "./Array/prototype.reduce": 72,
        "./Array/prototype.reduceRight": 73,
        "./Array/prototype.slice": 74,
        "./Array/prototype.some": 75
    }],
    65: [function(b, c, a) {
        if (!Array.isArray) {
            Array.isArray = function(d) {
    ...
    , {
        "./Date/now": 78,
        "./Date/prototype.toISOString": 79,
        "./Date/prototype.toJSON": 80
    }],
    78: [function(c, d, a) {
        if (!Date.now) {
            Date.now = function b() {
    ...
    , {
        "./Element/prototype.classList": 82
    }],
    82: [function(b, c, a) {
        /*! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js*/
        ;if ("document"in self) {
    ...
    , {
        "./shared/camelCasedEventTypes": 104,
        "./shared/prefixHelper": 106,
        "./shared/windowFallbackEventTypes": 109,
        "./utils/eventTypeAvailable": 110
    }],
    102: [function(f, d, h) {
    ...
    , {
        "./shared/getStyleTestElement": 105,
        "./shared/prefixHelper": 106,
        "./shared/stylePropertyCache": 107,
        "./utils/toCSS": 111,
        "./utils/toDOM": 112
    }],
    103: [function(d, b, h) {
    ...
    , {
        "./getStyleProperty": 102,
        "./shared/prefixHelper": 106,
        "./shared/stylePropertyCache": 107,
        "./shared/styleValueAvailable": 108
    }],
    104: [function(b, c, a) {
        c.exports = {
    ...
    , {
        "./getStyleTestElement": 105,
        "./stylePropertyCache": 107
    }],
    109: [function(b, c, a) {
    ...
    123: [function(i, d, s) {
        var j = i("@marcom/ac-headjs");
        var q = i("@marcom/ac-useragent");
        var f = i("@marcom/ac-feature/cssPropertyAvailable");
        var g = i("@marcom/ac-feature/webGLAvailable");
        var b = i("@marcom/ac-feature/threeDTransformsAvailable");
        var r = i("@marcom/ac-feature/isTablet");
        var m = i("@marcom/ac-feature/isHandheld");
        var n = i("./shared/model/HeroSupported");
        var h = i("./shared/model/ScrollMediaSupported");
        var a = i("./shared/model/GraphicsPerformanceController");
        var c = i("@marcom/ac-url/parseSearchParams");
        var p = i("@marcom/ac-url/joinSearchParams");
        var l = i("@marcom/ac-dom-events/addEventListener");
        var o = i("@marcom/ac-dom-traversal/querySelectorAll");
        var k = (function() {
            return {
                initialize: function() {
                    var u = (p(c(), false) === "759C7F62-0448-48D2-80CB-0B043DAC45A8");
                    var t = f("mask-image", "linear-gradient(#000, #fff)");
                    var x = !t && q.browser.firefox;
                    var w = t || x;
                    var y = (q.browser.ie);
                    var v = ((f("clip-path") || f("-webkit-clip-path")) && !q.browser.chrome);
                    j.addTests({
                        webgl: g,
                        "css-transform3d": b,
                        tablet: r,
                        handheld: m,
                        ios: q.os.ios,
                        ios8: (q.os.ios && q.os.version.major <= 8),
                        "css-mask": t,
                        "css-clip-path": x,
                        "css-mask-or-clip-path": w,
                        progressive: !y && !u,
                        "mediaObject-enabled": !y,
                        "in-view-sections": false,
                        "scroll-media": h.test,
                        "css-backdrop-filter": f("backdrop-filter"),
                        "hero-animated": n.test,
                        "paddle-clip-path": v,
                        "css-animations": f("animation-name"),
                        ie: q.browser.ie,
                        "high-gfx": a.getProfile() === a.HIGH
                    });
                    j.htmlClass();
                    window.progressiveTimeout = setTimeout(function() {
                        document.documentElement.classList.remove("progressive");
                        document.documentElement.classList.remove("in-view-sections")
                    }
                    .bind(this, j), 6500);
                    l(document, "DOMContentLoaded", function() {
                        if (!document.getElementsByTagName("body")[0].classList.contains("page-overview")) {
                            this.removeProgressiveImages()
                        }
                    }
                    .bind(this));
                    return this
                },
                removeProgressiveImages: function() {
                    var u = o(".progressive");
                    for (var t = 0; t < u.length; t++) {
                        u[t].classList.remove("progressive")
                    }
                }
            }
        }());
        d.exports = k.initialize()
    }
    , {
        "./shared/model/GraphicsPerformanceController": 124,
        "./shared/model/HeroSupported": 125,
        "./shared/model/ScrollMediaSupported": 126,
        "@marcom/ac-dom-events/addEventListener": 1,
        "@marcom/ac-dom-traversal/querySelectorAll": 16,
        "@marcom/ac-feature/cssPropertyAvailable": 21,
        "@marcom/ac-feature/isHandheld": 24,
        "@marcom/ac-feature/isTablet": 26,
        "@marcom/ac-feature/threeDTransformsAvailable": 28,
        "@marcom/ac-feature/webGLAvailable": 30,
        "@marcom/ac-headjs": 48,
        "@marcom/ac-url/joinSearchParams": 113,
        "@marcom/ac-url/parseSearchParams": 118,
        "@marcom/ac-useragent": 119
    }],
    124: [function(d, b, f) {
        var k = d("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var c = d("@marcom/ac-gpu-reporter/GPUReporter");
        var a = d("@marcom/ac-useragent");
        var i = d("@marcom/ac-feature/isTablet");
        var g = d("@marcom/ac-feature/webGLAvailable");
        var j = function() {
            k.call(this);
            if (!g()) {
                return
            ...
            this._profile = null ;
            this._reporter = new c();
            this._gpuClass = this._reporter.getGPUClass({
                whitelist: ["Apple A8X GPU", "Apple Software Renderer"]
            });
            this._boundGetProfile = this.getProfile.bind(this)
        };
        var h = j.prototype = Object.create(k.prototype);
        h.LOW = 1;
        h.MEDIUM = 2;
        h.HIGH = 3;
        h.getGPU = function() {
            ...
            return this._reporter.getGPU() || ""
        }
        ;
        h.getProfile = function() {
            if (!this._reporter) {
                return this.LOW
            }
            var l = this._getProfile();
            this._setProfile(l);
            return l
        }
        ;
        h._getProfile = function() {
            var l = this._gpuClass;
            if (a.browser.firefox && this._isRetina()) {
                return this.LOW
            }
            if (l === this._reporter.BLACKLISTED || l === this._reporter.NO_WEBGL) {
                return this.LOW
            }
            if (l === this._reporter.NOT_FOUND || l === this._reporter.NOT_LISTED) {
                if (this._getMaxAnisotropy() < 16 || this._getIsIntegratedRetina() || this._isNonProIPad()) {
                    return this.LOW
                }
            }
            return this.HIGH
        ...
        ;
        h._getIsIntegratedRetina = function() {
            return a.browser.safari && a.os.osx && this._isRetina() && window.screen.width < 1800
        }
        ;
        h._isNonProIPad = function() {
            return a.os.ios && i()
        }
        ;
        h._setProfile = function(l) {
            if (this._profile === l) {
                return
            }
            this._profile = l;
        ...
        h._getMaxAnisotropy = function() {
            ...
            try {
                ...
                var p = m.getContext("webgl") || m.getContext("experimental-webgl");
                ...
                if (n) {
                    l = p.getParameter(n.MAX_TEXTURE_MAX_ANISOTROPY_EXT)
                }
            } catch (o) {}
            this._maxAnisotropy = l;
            return this._maxAnisotropy
        }
        ;
        h._isRetina = function() {
    ...
    , {
        ...
        "@marcom/ac-feature/isTablet": 26,
        "@marcom/ac-feature/webGLAvailable": 30,
        "@marcom/ac-gpu-reporter/GPUReporter": 33,
        "@marcom/ac-useragent": 119
    }],
    125: [function(b, a, c) {
        var j = b("@marcom/ac-useragent");
        var d = b("@marcom/ac-feature/webGLAvailable");
        var h = b("@marcom/ac-feature/threeDTransformsAvailable");
        var i = b("@marcom/ac-feature/continuousScrollEventsAvailable");
        var f = b("@marcom/ac-feature/isHandheld");
        var g = b("./GraphicsPerformanceController");
        a.exports = {
            test: function() {
                if (j.os.ios && j.os.version.major <= 8) {
                    return false
                }
                if (j.os.ios && f() && window.innerWidth >= 736) {
                    return false
                }
                return (g.getProfile() > g.LOW) && d() && h() && i()
            }
        }
    }
    , {
        "./GraphicsPerformanceController": 124,
        "@marcom/ac-feature/continuousScrollEventsAvailable": 20,
        "@marcom/ac-feature/isHandheld": 24,
        "@marcom/ac-feature/threeDTransformsAvailable": 28,
        "@marcom/ac-feature/webGLAvailable": 30,
        "@marcom/ac-useragent": 119
    ...
    126: [function(c, a, d) {
        var k = c("@marcom/ac-useragent");
        var f = c("@marcom/ac-feature/webGLAvailable");
        var h = c("@marcom/ac-feature/threeDTransformsAvailable");
        var j = c("@marcom/ac-feature/continuousScrollEventsAvailable");
        var i = c("./GraphicsPerformanceController");
        var g = c("@marcom/ac-feature/isHandheld");
        var b = c("@marcom/ac-jetpack-lib/model/EnabledFeatures");
        a.exports = {
            test: function() {
                if (i.getGPU().indexOf("Apple A9X GPU") > -1) {
                    return false
                }
                if (k.os.ios && k.os.version.major <= 8) {
                    return false
                }
                if (k.os.ios && g() && window.innerWidth >= 736) {
                    return false
                }
                return (i.getProfile() > i.LOW) && f() && h() && j() && !b.IS_IE8
            }
        }
    }
    , {
        ...
        "@marcom/ac-feature/threeDTransformsAvailable": 28,
        "@marcom/ac-feature/webGLAvailable": 30,
        "@marcom/ac-jetpack-lib/model/EnabledFeatures": 50,
        "@marcom/ac-useragent": 119
    }]
}, {}, [123]);
