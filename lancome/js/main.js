...
canvasImgs = [_CDN + "img/star.png", _CDN + "img/answer-1-bg.jpg", _CDN + "img/answer-1-mark-bg.jpg", _CDN + "img/answer-2-bg.jpg", _CDN + "img/mark-1.png", _CDN + "img/mark-2.png", _CDN + "img/item-elephant.png", _CDN + "img/item-owl.png", _CDN + "img/item-panda.png", _CDN + "img/symbol.png"];
        ...
        return axios.get("//music.163.com/api/activity/lancome/userInfo?type=1").then(function (msg) {
          ...
          if (d.code === 200) {
            if (d.data.hottestSongName != null && d.data.hottestSongName !== "") {
              _this2.musicName = d.data.hottestSongName;
            }
  ...
  var buildUGC = function () {
    ...
    _createClass(buildUGC, [{
      ...
      value: function build() {
        ...
        bg = new PIXI.Sprite(PIXI.loader.resources[_CDN + ("img/ugc-bg-" + this.id + ".jpg")].texture);
      ...
      value: function init(callback, id) {
        ...
        return PIXI.loader.add([_CDN + ("img/ugc-bg-" + id + ".jpg"), _CDN + "img/ugc-qr.png"]).load(this.build.bind(this));
      }
    }]);
  ...
  var createAnswer = function () {
    ...
    _createClass(createAnswer, [{
      ...
      value: function build3() {
        ...
        bg = this.dom.bg3 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/answer-3-bg.jpg"].texture);
        bg.alpha = 0.6;
        bg.x = 100;
        this.ansStar.stage.addChildAt(this.dom.bg3, 0);
        screen = this.dom.screen = new PIXI.Container();
        timeline = this.dom.timeline = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/mobile-timeline.png"].texture);
        timeline.x = 220;
        timeline.y = 565;
        timeline.alpha = 0;
        timeline1 = this.dom.timeline1 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/mobile-answer.json"].textures['mobile-answer-1.png']);
        timeline1.x = 272;
        timeline1.y = 685;
        timeline1.alpha = 0;
        timeline2 = this.dom.timeline2 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/mobile-answer.json"].textures['mobile-answer-2.png']);
        timeline2.x = 272;
        timeline2.y = 685;
        timeline2.alpha = 0;
        timeline3 = this.dom.timeline3 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/mobile-answer.json"].textures['mobile-answer-3.png']);
        timeline3.x = 272;
        timeline3.y = 685;
        timeline3.alpha = 0;
      ...
      value: function build2() {
        ...
        this.dom.bg2 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/answer-2-bg.jpg"].texture);
        this.ansStar.stage.addChildAt(this.dom.bg2, 0);
        music = this.dom.music = new PIXI.Container();
        symbol1 = this.dom.symbol1 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/symbol.png"].texture);
        symbol2 = this.dom.symbol2 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/symbol.png"].texture);
        symbol3 = this.dom.symbol3 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/symbol.png"].texture);
        symbol1.x = 99;
        symbol1.y = 690;
        symbol2.x = 110;
        symbol2.y = 717;
      ...
      value: function build() {
        ...
        // background image
        this.dom.bg = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/answer-1-mark-bg.jpg"].texture);
        bg = this.dom.bg;
        ...
        this.scaleP.x = 1.2;
        this.scaleP.y = 1.2;
        this.dom.mark = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/mark-1.png"].texture);
        this.dom.mark2 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/mark-2.png"].texture);
        ...
        answer1bg.mask = mark;
        this.dom.answer11 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/item-owl.png"].texture);
        this.dom.answer11.anchor.set(0.5);
        this.dom.answer11.x = 450;
        this.dom.answer11.y = 310;
        this.dom.answer12 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/item-elephant.png"].texture);
        this.dom.answer12.anchor.set(0.5);
        this.dom.answer12.x = 320;
        this.dom.answer12.y = 530;
        this.dom.answer13 = new PIXI.Sprite(PIXI.loader.resources[_CDN + "img/item-panda.png"].texture);
      ...
      value: function init() {
        ...
        return PIXI.loader.add([_CDN + "img/mobile-answer.json", _CDN + "img/answer-3-bg.jpg", _CDN + "img/mobile-timeline.png"]).load(this.build.bind(this));
      }
    }]);
