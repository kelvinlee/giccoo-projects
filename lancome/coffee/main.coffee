...
textsBox = [
	...
	[["你的感知神经似乎不太敏感","偶尔空虚，经常充实才是生活常态","寂寞的时候默念咒语","把大家都变成猪你就不孤独啦"],["你有时候也想45度静静仰望天空","但眼泪似乎不太掉得下来","孤独的感觉总是像龙卷风一样袭来","不过还好","你不是站在风暴中心的那个人"]]
	...
	[["你幻想自己是一只鱼","以为7秒就能忘记那种寂寞的感觉","但是上帝并不理你","你还是那个孤独到要爆炸的人类"]]
]
scoreBox = [
	[11,17,1],
	[2,5,12],
