...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, CompanyPage, Done, POST, SendNote, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _QUESTION, _citys, company, css3Prefix, hideFocus, hideShare, i, j, len, loadEnd, loadStart, mTestElement, showFocus, showShare;
...
window.onload = function() {
  ...
  return $(".btn-personal").click(function() {
    if (subscribe === 0) {
      return showFocus();
    }
