...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, FormHeight, Loader, SendNote, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _loader, _startDate, _stepList, cdn, css3Prefix, debug, global, hideSelfPage, i, isMM, j, layzr, len, link, loadWechatConfig, mTestElement, mainSlider, oldslideNumber, pc, qrcode, secondSlider, tabId, tabId2, taskData, tm, uid;
...
window.onload = function() {
  ...
  $(".btn").on("click", function() {
    ...
    if ($(this).attr("data-content")) {
      ...
      return Store.contentx.updateContents(headline, json);
    }
  });
  loadWechatConfig();
  wx.ready(function() {
