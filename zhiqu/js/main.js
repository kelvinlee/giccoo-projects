...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, TRANSITION_END_NAME, TRANSITION_END_NAMES, TrunCheck, VENDORS, _gifCount, _gifnow, awardList, backBottle, backBottleMain, brandShow, clearNone, css3Prefix, global, hideFirstPage, i, imageList, images, imgs, init, j, len, loadEnd, loadGIF, loadStart, loaded, logoShow, mTestElement, mediaShow, openAward, openBottle, openBottleMain, openBrand, openMedia, opened, page, pages, startLoadPage, stop, strategyShow, tags, technologyShow, test;
...
TrunCheck = function() {
  ...
  $(".p-box.index .people").each(function(i) {
    if (parseInt($(".over", this).css("opacity"))) {
      if ((global != null) && (global["technologypeople" + (i + 1)] != null) && (global["technologypeople" + (i + 1)].play !== "replay" && global["technologypeople" + (i + 1)].play !== "stop")) {
        return global["technologypeople" + (i + 1)].replay("replay");
      }
    } else {
      if ((global != null) && (global["technologypeople" + (i + 1)] != null)) {
