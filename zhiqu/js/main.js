...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, awardList, backBottle, backBottleMain, brandShow, clearNone, css3Prefix, global, i, imageList, images, imgs, init, j, len, loadAllImage, loadComper, loadFinished, mTestElement, openAward, openBottle, openBottleMain, openBrand, openMedia, opened, page, pages, tags;
...
window.onload = function() {
  ...
  return $(".firstPage .content").on("click", init);
};
...
clearNone = function() {
  return setTimeout(function() {
    return $(".pages-brand .brands-item").html("");
  }, 500);
};
...
brandShow = function() {
  ...
  return setTimeout(function() {
    ...
    return $(".pages-brand .brands-item").html("<div class='brand-item brand-item-1' ></div><div class='brand-item brand-item-2' ></div>");
  }, 1700);
};
