...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, TRANSITION_END_NAME, TRANSITION_END_NAMES, TWidth, TrunCheck, VENDORS, XList, _gifCount, _gifnow, awardList, backBottle, backBottleMain, brandLoadEnd, brandShow, clearNone, contactusLoadEnd, css3Prefix, global, hideFirstPage, i, imageList, images, imgs, init, j, len, loadEnd, loadGIF, loadStart, loaded, logoLoadEnd, logoShow, mTestElement, mediaShow, openAward, openBottle, openBottleMain, openBrand, openMedia, opened, page, pages, startLoadPage, stop, strategyShow, tags, technologyShow, test;
