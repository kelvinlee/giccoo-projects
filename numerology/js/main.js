...
function loadingAni(){
  ...
  TweenLite.to($("#loadingC2"),60,{rotation:-720,ease:Linear.easeIn,onUpdate:function(){ n = n+(Math.random()+0.1); if (n >= 100) {n = 100} $("#loadingT").text(parseInt(n)+"%") },onComplete:page1in})
