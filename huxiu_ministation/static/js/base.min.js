;/*!/vendors/js/jquery-1.11.2.min.js*/
...
;/*!/vendors/js/main.js*/
var main=main||{creatDvaluation:function(i){console.log(i);var o=[];$.each(i,function(n,t){o.push("<li>"),o.push('<img src="'+t.user.avatar+'" class="avatar">'),o.push('<div class="user-info">'),o.push('    <div class="clearfix">'),o.push("          <h3>"+t.user.name+"</h3>"),o.push('          <div class="pull-right">'+t.user.title+"</div>"),o.push("    </div>"),o.push("    <em></em>"),o.push("    <span>"+t.user.info+"</span>"),o.push("</div>"),o.push('<p class="intro-tip">'),o.push(""!=i.msg?'<a href="javascript:void(0)" data-index="'+n+'">查看详情</a>':'<a href="javascript:void(0)">敬请期待</a>'),o.push("<em></em></p>"),o.push("</li>")}),$("#dvaluationContent").append(o.join("\n")),main.tabMouseInfo("#tab_1 li",".intro-tip")},tabMouseInfo:function(i,o){var n=$(i);n.hover(function(){var i=n.index($(this));mst=setTimeout(function(){index=i,n.eq(index).find(o).show()},150)},function(){clearTimeout(mst),$(this).find(o).hide()})}},dialog=dialog||{show:function(i){var o='<div id="dialog"><div class="mask"></div><div class="dialog"><div class="title">'+i.user.name+'<a href="javascript:void(0)" class="close-btn"></a></div><div class="clearfix"><div class="left"><img src="'+i.user.avatar_1+'"><h2>'+i.user.name+"</h2><p>"+i.user.title+'</p></div><div class="right"><div class="content">'+i.msg+'</div></div></div><a href="http://ms.qq.com/" target="_blank"><img src="static/img/dialog-banner.png" class="dialog-banner"></a></div></div>';$("body").append(o),$("body").on("click",".close-btn",function(){dialog.hide()})},hide:function(){$("#dialog").remove()}};$(function(){main.creatDvaluation(dvaluation),$("#tab_1 li a").on("click",function(){var i=$(this).data("index");dialog.show(dvaluation[i])}),$("#btn_gotop").on("click",function(){$("html,body").animate({scrollTop:0},500)}),$(window).on("scroll",function(){var i=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0;200>i?$("#btn_gotop").removeClass("show"):$("#btn_gotop").hasClass("show")||$("#btn_gotop").addClass("show")}),$("#weibo").on("click",function(){!function(i,o,n){function t(){window.open([e,s].join(""))||(a.href=[e,s].join(""))}try{}catch(n){}var e="http://v.t.sina.com.cn/share/share.php?",a=o.location.href,s=["url=",n(a),"&title=",n(sharetitle),"&appkey=1934882415","&pic=",n(shareUrl)].join("");/Firefox/.test(navigator.userAgent)?setTimeout(t,0):t()}(screen,document,encodeURIComponent)}),$("#qq").on("click",function(){!function(i,o,n){function t(){window.open([e,s].join(""))||(a.href=[e,s].join(""))}try{}catch(n){}var e="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?",a=o.location.href,s=["url=",n(a),"&showcount=0","&desc=",n(sharetitle),"&summary=","&title=",n(sharetitle),"&site=虎嗅网&pics=",n(shareUrl),"&style=203&width=22&height=22&otype=share"].join("");/Firefox/.test(navigator.userAgent)?setTimeout(t,0):t()}(screen,document,encodeURIComponent)}),$("#weixin").on("mouseover",function(){$("#qrcode").addClass("show")}).on("mouseout",function(){$("#qrcode").removeClass("show")})});