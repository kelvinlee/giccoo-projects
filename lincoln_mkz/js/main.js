...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, EndLastFrame, FormHeight, FrameFun, Loader, SendNote, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _loader, _startDate, _stepList, cdn, css3Prefix, debug, global, i, isMM, j, layzr, len, link, loadedEnd, mTestElement, mainSlider, pc, qrcode, secondSlider, tabId, tabId2, taskData, tm, uid;
...
window.onload = function() {
  ...
  $(".btn-reset").on("click", function() {
    ...
    return _hmt.push(['_trackEvent', "lincoln_mkz", "充值1小时", "-", "-"]);
  });
  ...
  return $(".form-register .title").on("click", function() {
