...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, Car, TRANSITION_END_NAME, TRANSITION_END_NAMES, UpdateShare, VENDORS, css3Prefix, i, imageList, imgs, j, len, loadAllImage, loadComper, loadFinished, loadWechatConfig, mTestElement;
...
imageList = ["img/bar-text.png", "img/bar-in.png", "img/bar-up.png", "img/cup-1.png", "img/cup-2.png", "img/cup-3.png", "img/cup-4.png", "img/answer-1.png", "img/answer-2.png", "img/answer-3.png", "img/answer-4.png", "img/select-btn.png", "img/back-home.png", "img/pop-bg.png", "img/btn-share.png", "/libs/img/wechat.png"];
