...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _CDN, bs, createTimeWait, css3Prefix, defaultY, ds, fisrtPage, i, initPlanets, initVuePlanetInfoPage, initVuePlanetsMedal, j, jsList, k, lastPageShow, len, listLoaded, load, loadAllScript, loadWechatConfig, loadedAll, mTestElement, markers, planetInfo, planetinfopage, planetlastpage, planets, planetsList, planetstars, setAstarLight, shareContent;
...
Vue.component("player", {
  template: '<div class="playsound"> <div class="icon-play" :class="{play: playing, pause: !playing}" @click="change"> <img :src="iconNow" /> </div> <audio :src="src" autoplay="true" loop="loop"></audio> <audio :src="otherSrc"></audio> </div>',
  data: function() {
    return {
      src: "./mp3/bgm.mp3",
      otherSrc: "",
