...
riot.tag('share', '<div class="note-title fadeInLeft animated delay-5"><img riot-src="http://disk.giccoo.com/projects/Tongshuai/img/{opts.name}-title.png"></div> <div class="t-shirt fadeInLeft animated delay-8"> <div class="clear"><img src="http://disk.giccoo.com/projects/Tongshuai/img/t-shirt.png"></div> <div if="{icon || text || stamp}" class="icons"> <div if="{icon}" class="icon1 {icon}"><img riot-src="http://disk.giccoo.com/projects/Tongshuai/img/{icon}.png"></div> <div if="{text}" class="icon2 {text}"><img riot-src="http://disk.giccoo.com/projects/Tongshuai/img/{text}-dark.png"></div> <div if="{stamp}" class="icon3 {stamp}"><img riot-src="http://disk.giccoo.com/projects/Tongshuai/img/{stamp}.png"></div> <div class="kv"><img src="http://disk.giccoo.com/projects/Tongshuai/img/kv-2.png"></div> </div> </div> <div if="{opts.name==\'notes\'}" class="share-icons fadeInLeft animated delay-10"> <div class="share"></div> <shareicon site="Tongshuai" title="“小行走大改变”，现场版奔跑吧兄弟等你来挑战！" url="local" pic="http://disk.giccoo.com/projects/Tongshuai/img/share-pc.jpg" icons="douban,weibo,qzone,wechat"><span class="share-icon">分享到</span></shareicon> </div><a if="{opts.name==\'share\'}" href="#/" class="join fadeInLeft animated delay-10"><img src="http://disk.giccoo.com/projects/Tongshuai/img/join.png"></a>', function(opts) {
    var self = this
