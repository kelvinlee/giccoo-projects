...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, Loader, SendNote, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _citys, _loader, _moving, _type, backHome, cdn, changeMain, changePoint, css3Prefix, debug, global, i, isMM, j, layzr, len, link, loadImage, mLeft, mRight, mTestElement, moveLeft, moveRight, qrcode, secondSlider, sliderBox, tabId, tabId2, tm;
...
window.onload = function () {
  ...
  $(".homepage .btn-2").on("click", function (evt) {
    if (_moving) {
      return false;
    }
    _moving = true;
  ...
  $(".homepage .btn-3").on("click", function (evt) {
    if (_moving) {
      return false;
    }
    _moving = true;
  ...
  $(".startpage .btn.start").on("click", function (evt) {
    if (_moving) {
      return false;
    }
    _moving = true;
