...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, EndLastFrame, FormHeight, FrameFun, Loader, SendNote, Stars, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _loader, _startDate, _stepList, cdn, changeMain, css3Prefix, debug, global, hideSelf, i, isMM, j, layzr, len, link, loadWechatConfig, loadedEnd, mTestElement, mainSlider, oldslideNumber, passFun, pc, playerDraw, qrcode, riots, secondSlider, tabId, tabId2, taskData, tm, uid;
