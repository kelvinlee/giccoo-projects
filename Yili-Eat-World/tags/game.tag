...
<game>
  ...
  <div show="{lastPage}" class="active-over">
    <div class="over-list fadeInDown animated delay-5">
    ...
    <div class="over-score fadeInDown animated delay-7">
      <p>获得 {score} 能量</p>
    </div>
    <div class="over-title fadeInDown animated delay-9"><img data-layzr="http://disk.giccoo.com/projects/Yili-Eat-World/img/game-over-title.png"/>
      <div class="over-title-text tada animated delay-11"><img src="http://disk.giccoo.com/projects/Yili-Eat-World/img/game-over-title-{overtitle}.png"/></div>
    </div>
    <div class="over-note fadeInDown animated delay-13"><img data-layzr="http://disk.giccoo.com/projects/Yili-Eat-World/img/game-over-note.png"/></div>
    <div id="share-icons" class="share-icons fadeInDown animated delay-15">
    </div>
    <div onclick="{resetGame}" class="over-regame fadeInDown animated delay-17"><img data-layzr="http://disk.giccoo.com/projects/Yili-Eat-World/img/again.png"/></div>
  ...
  <script>
    ...
    this.gameover = function(list) {
    	...
    	var number = parseInt((new Date().getTime() - new Date(1431878400000).getTime()) / 1000 / 60 * 5500/(24*60))
