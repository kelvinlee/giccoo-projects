...
p0_title.css(	{'-webkit-transform': 'translate3d('+(_gamma/12-50)+'%,'+(_beta/6-50)+'%,  0)','transform': 'translate3d('+(_gamma/12-50)+'%,'+(_beta/6-50)+'%,  0)'})
...
p0pic4.css(	{'-webkit-transform': 'translate3d('+(_gamma/4)+'%,'+_beta/8+'%,  0)','transform': 'translate3d('+(_gamma/4)+'%,'+_beta/8+'%,  0)'})
