...
p0pic1.css(	{'-webkit-transform': 'translate3d('+Math.abs(event.gamma/10)+'%,'+event.beta/10+'%,  0)','transform': 'translate3d('+Math.abs(event.gamma/10)+'%,'+Math.abs(event.beta/10)+'%,  0)'})
p0pic2.css(	{'-webkit-transform': 'translate3d('+Math.abs(event.gamma/8)+'%,'+event.beta/8+'%,  0)','transform': 'translate3d('+Math.abs(event.gamma/8)+'%,'+Math.abs(event.beta/8)+'%,  0)'})
p0pic3.css(	{'-webkit-transform': 'translate3d('+Math.abs(event.gamma/6)+'%,'+event.beta/6+'%,  0)','transform': 'translate3d('+Math.abs(event.gamma/6)+'%,'+Math.abs(event.beta/6)+'%,  0)'})
p0pic4.css(	{'-webkit-transform': 'translate3d('+Math.abs(event.gamma/4)+'%,'+event.beta/4+'%,  0)','transform': 'translate3d('+Math.abs(event.gamma/4)+'%,'+Math.abs(event.beta/4)+'%,  0)'})
