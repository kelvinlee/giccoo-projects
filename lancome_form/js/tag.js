...
riot.tag('register', 
    ...
    this.submit = function() {
        ...
        if ( $("[name=city]",this.root).val().length < 1 || $("[name=city]",this.root).val() == "") {
            alert("寄送地址不能为空")
            return false
        }
