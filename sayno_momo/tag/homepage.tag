	...
	.pop.active-info.fadeIn.animated(show="{activeinfo}")
		...
		.content
			.content-text
				...
				p 发布作品之后分享给好友或者分享到附近动态，即可参与抽奖，奖品包含荣耀7i手机和荣耀自拍杆等。
				p *每次发布作品之后分享可进行一次抽奖
				...
				p 活动主办方、关联公司及其授权的广告公司、网络合作伙伴等的员工及其家属不可参加此次活动，以示公允。
				p 每位参加活动的用户理解并同意，为联系获奖用户以及奖品发放的需要，用户须在参与活动之时提供诸如姓名、联系方式、电子邮箱、通讯地址等真实个人信息，活动主办方将仅为前述目的以及适用法律所允许的最大限度内收集和使用用户的个人信息。获奖用户须确保其提供的个人信息完整、准确。
				p 由于获奖用户自身原因 （包括但不限于在中奖后2个小时内未能及时填写联系信息或者填写的联系信息不准确、不全面导致主办方无法与之取得联系，或因用户自身原因无法联系等） 造成奖品无法领取的，将被视作获奖用户自动放弃其领奖权利。活动主办方对此将不承担任何责任，不再另行通知也不再进行补发。
				p 活动奖品图片仅供参考，所有奖品均以实物为准，不设退换服务。如遇质量问题，获奖用户请直接与奖品生产商或者指定经销商联系，并按照正常的退换货和维修规则办理，活动主办方不承担责任。
				p 如遇意外，无法提供指定奖品的，活动主办方有权以价值相仿的奖品替代，但所有奖品不得兑换现金或作价销售。
				p 收到活动主办方派送的奖品后，请获奖用户当场确认奖品是否完好。若发现异常请直接与送件人员提出，若签收后发现奖品损坏，活动主办方将不承担责任。非由活动主办方故意或重大过失造成获奖者在领取和使用奖品过程中所发生的事故，活动主办方无须承担相应负责。
