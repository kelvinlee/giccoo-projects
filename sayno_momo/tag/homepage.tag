homepage
	...
	.pop.active-info.fadeIn.animated(show="{activeinfo}")
		...
		.content
			.content-text
				p 活动形式：
				ol
					li 点击进入活动页面，在荣耀logo模板下，上传图片并发表「异见」;
					li 发布作品之后分享给好友或者分享到附近动态，即可参与抽奖，奖品包含荣耀7i手机和荣耀自拍杆等。
				p *每次发布作品之后分享可进行一次抽奖
				p *抽中奖品但未在2个小时内填写联系方式则视为用户自动放弃奖品，将不再进行通知
				...
				p 活动规则：
				ol
					li 本次活动主办方为华为终端（东莞）有限公司。
					li 
						p 所有参与用户完全有权自愿选择是否参加本次活动，一旦参与本次活动的任何一个环节或全部，即视为已完全了解并完全接受包括本细则及其解释在内的各项条款。
						p ·主办方拥有无限制使用本次活动产生的全部资料、照片等的授权
					li 活动参与用户同意并授予活动主办方无偿使用活动参与用户信息用于活动宣传的权利，参与用户信息包括但不限于用户头像、昵称、文字、图片等，包括但不限于将用户信息用于网络媒体、平面媒体、印刷品、 影展、零售店、路演等活动宣传当中，活动主办方据此使用参与活动的用户信息时不需要再另行通知活动参与用户或征得活动参与者的同意。
					li 活动主办方、关联公司及其授权的广告公司、网络合作伙伴等的员工及其家属不可参加此次活动，以示公允。
					li 每位参加活动的用户理解并同意，为联系获奖用户以及奖品发放的需要，用户须在参与活动之时提供诸如姓名、联系方式、电子邮箱、通讯地址等真实个人信息，活动主办方将仅为前述目的以及适用法律所允许的最大限度内收集和使用用户的个人信息。获奖用户须确保其提供的个人信息完整、准确。
					li 由于获奖用户自身原因 （包括但不限于在中奖后2个小时内未能及时填写联系信息或者填写的联系信息不准确、不全面导致主办方无法与之取得联系，或因用户自身原因无法联系等） 造成奖品无法领取的，将被视作获奖用户自动放弃其领奖权利。活动主办方对此将不承担任何责任，不再另行通知也不再进行补发。
					li 活动奖品图片仅供参考，所有奖品均以实物为准，不设退换服务。如遇质量问题，获奖用户请直接与奖品生产商或者指定经销商联系，并按照正常的退换货和维修规则办理，活动主办方不承担责任。
					li 如遇意外，无法提供指定奖品的，活动主办方有权以价值相仿的奖品替代，但所有奖品不得兑换现金或作价销售。
					li 收到活动主办方派送的奖品后，请获奖用户当场确认奖品是否完好。若发现异常请直接与送件人员提出，若签收后发现奖品损坏，活动主办方将不承担责任。非由活动主办方故意或重大过失造成获奖者在领取和使用奖品过程中所发生的事故，活动主办方无须承担相应负责。
					li 本次活动所产生的个人偶然所得税由获奖用户本人承担。
					li 如果发现有参加者在活动中使用任何不正当的手段参加活动，活动主办方有权在不事先通知的前提下取消其参加活动的资格。
					li 主办方不对因网络传输原因而导致参与用户提交的信息错误或延误承担任何责任。如遇不可抗力因素，活动主办方拥有终止或取消本次活动的权利。
					li 
					...
					li 因参与本活动引起的或者与本活动有关的争议，应本着友好合作精神协商解决，若自开始协商之日起15日内协商不成的，双方同意将争议提交深圳市龙岗区人民法院解决。
	...
	script(type="text/coffeescript").
		...
		this.start = ->
			@buildpage = true
			# _link = $(".pages .logo img").attr("src")
			# _link = _link.replace("logo","logo-1")
			# $(".pages .logo img").attr("src",_link)
			# @update()
			setTimeout ->
