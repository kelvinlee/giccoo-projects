...
riot.tag2('homepage', '<div show="{!buildpage}" class="show-page"> <div class="bg flipInY animated delay-7"><img src="http://image.giccoo.com/projects/sayno_momo/img/homepage-bg.png"></div> <div class="text-1 fadeInDown animated delay-5"><img src="http://image.giccoo.com/projects/sayno_momo/img/homepage-text-1.png"></div> <div class="text-2 bounceIn animated delay-9"><img src="http://image.giccoo.com/projects/sayno_momo/img/homepage-text-2.png"></div> <div onclick="{start}" class="start fadeInUp animated delay-11"><img src="http://image.giccoo.com/projects/sayno_momo/img/homepage-start.png"></div> <div onclick="{showActive}" class="active fadeInUp animated delay-12">活动细则</div> </div> <div show="{buildpage}" class="build-page fadeIn animated"> <div class="build"> <ctrl-image selectimage="selectFiles"> <div class="logo"><img src="http://image.giccoo.com/projects/sayno_momo/img/logo-mark.png"></div> </ctrl-image> <div class="title"> <div class="line normal"><img src="http://image.giccoo.com/projects/sayno_momo/img/build-title.png"></div> <div class="line input"> <input id="title" type="text" name="title"> <div class="bg"><img riot-src="http://image.giccoo.com/projects/sayno_momo/img/build-title-bg-{INDEX}.png"></div> </div> </div> <div class="image-slogen"><img src="http://image.giccoo.com/projects/sayno_momo/img/image-slogen.png"></div> </div> <div id="submit" show="{!submited}" onclick="{submit}" class="submit"><img src="http://image.giccoo.com/projects/sayno_momo/img/submit.png"></div> <div show="{submited}" class="share-box"> <div class="bg"><img src="http://image.giccoo.com/projects/sayno_momo/img/phone.png"></div> <div onclick="{share}" class="btn btn-share"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-share.png"></div> <div onclick="{showOthers}" class="btn btn-others"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-others.png"></div> </div> </div> <div show="{sharedsuccess}" class="pop share-success fadeIn animated"> <h2>分享成功!</h2> <div class="line"></div> <div onclick="{postLottery}" class="btn btn-lottery"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-lottery.png"></div> </div> <div show="{otherspage}" class="pop other-page fadeIn animated"> <div class="other-box"> <div onclick="{closeOther}" class="close"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-close.png"></div> <slider callback="{sliderEnd}"> <ul each="{items in parent.lists}" class="slide"> <li each="{item in items}" onclick="{parent.parent.parent.showInfo}" rel="http://image.giccoo.com/sayno/momo/{item.src}@!large"><img riot-src="http://image.giccoo.com/sayno/momo/small-{item.src}@!medium"></li> </ul> </slider> <div class="line">向左滑动换一批》</div> </div> </div> <div show="{lotteryfaild}" class="pop lottery-faild fadeIn animated"> <div class="content"> <div class="title"><img src="http://image.giccoo.com/projects/sayno_momo/img/lottery-faild-title.jpg"></div> <div class="body"> <p>但是你还有机会继续抽奖</p> <div class="product"></div> <div onclick="{restart}" class="btn btn-goback"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-goback.jpg"></div> </div> <div class="footer"></div> </div> </div> <div show="{lotterysuccess}" class="pop lottery-success fadeIn animated"> <div class="content"> <div class="title"><img src="http://image.giccoo.com/projects/sayno_momo/img/lottery-success-title.jpg"></div> <div class="body"> <div show="{submitsuccess}" class="success-note"> <p>提交成功,请耐心等待奖品.</p> <div onclick="{restart}" class="btn btn-goback"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-goback.jpg"></div> </div> <form name="register" show="{!submitsuccess}" class="form"> <div class="form-group"> <input id="name" type="text" name="name" placeholder="请输入用户名"> </div> <div class="form-group"> <input id="mobile" type="text" name="mobile" placeholder="请输入手机号"> </div> <div class="form-group"> <input id="adr" type="text" name="adr" placeholder="请输入联系地址"> </div> <div onclick="{submitLottery}" class="btn btn-submit"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-submit.jpg"></div> </form> </div> <div class="footer"></div> </div> </div> <div show="{activeinfo}" class="pop active-info fadeIn animated"> <div class="title">活动形式</div> <div onclick="{closeactive}" class="close"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-close.png"></div> <div class="content"> <div class="content-text"> <p>活动形式：</p> <p>1)发表「异见」上传图片</p> <p>2)发布作品之后分享给好友或者到附近动态，即可参与抽奖，奖品包含：</p> <p>- 荣耀小口哨蓝牙耳机（199元）</p> <p>- 荣耀自拍杆（49元）</p> <p>- 荣耀7i手机（1399元）</p> <p>*每次发布作品之后分享可进行一次抽奖</p> <p>*如发现参与者恶意上传重复作品或者与主题无关作品，将在未进行通知情况下取消其获奖资格</p> <p></p> <p>活动时间：</p> <p>2016年4月15日至2016年5月10日24:00止</p> <p>·本次活动主办方为华为荣耀有限公司</p> <p>·本次活动产生的全部资料、照片等所有权及知识产权均属主办方所有</p> <p>·参与者如违反下列任一情况的，主办方有权在不予通知情况下屏蔽其作品</p> <p>1)内容违法或唆使违法、唆使虐待及自残等行为的动机</p> <p>2)内容不得带有歧视、不得涉及政治、宗教等</p> <p>3)内容不得扰乱社会公共秩序</p> <p>4)不侵犯他人或机构的著作权、专利权或商标权等相关知识产权</p> <p>5)不侵犯他人肖像权或隐私</p> <p>6)不损害他人名誉、信用，无导致他人不快等内容</p> </div> </div> </div> <div show="{imageInfo}" class="pop image-info fadeIn animated"> <div onclick="{closeInfo}" class="close"><img src="http://image.giccoo.com/projects/sayno_momo/img/btn-close.png"></div> <div class="content"><img riot-src="{imagelarge}"></div> </div>', '', '', function(opts) {
