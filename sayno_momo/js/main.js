...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, INDEX, Loader, SendNote, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, UpdateShare, UpdateShareContent, VENDORS, _loader, cdn, closeWaiting, css3Prefix, debug, defaultWords, global, hideShareWechat, i, isMM, j, layzr, len, link, loadStart, mTestElement, opendWaiting, qrcode, selectFiles, sending, share, shareCall, shareEnd, shareOneToAll, shared, tm, uploadImage;
...
uploadImage = function uploadImage(next) {
    ...
    return createFullImage(function () {
        ...
        return $.post(link + "/sayno/momo/create", data, function (msg) {
            sending = false;
            if (msg.recode === 200) {
                // alert "Success"
                // showShare()
