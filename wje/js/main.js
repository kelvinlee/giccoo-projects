...
function initAll(){
  stageW=750
  stageH=screenH/screenW*750

  renderer=new PIXI.Application({width:750,height:stageH,transparent: true,preserveDrawingBuffer: true})
...
var mainPic=new pSprite("img/main.jpg")
function getStart(){
  pStage.addChild(mainPic)
  mainPic.pivot.set(375,1170/2)
  mainPic.position.set(375,stageH/2)
}
