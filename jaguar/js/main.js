...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, SendNote, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, _budget, _buytime, _citys, _type, changeMain, changePoint, css3Prefix, i, j, len, mLeft, mRight, mTestElement, mainSlider, moveLeft, moveRight, secondSlider, showTab, tabId, tabId2;
...
moveLeft = function moveLeft(evt) {
  ...
  return secondSlider.setNumber($(evt.target).index());
};
