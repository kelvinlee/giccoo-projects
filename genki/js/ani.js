...
var p1pic1a=new pSprite("//image.giccoo.com/projects/genki/img/part1pic1aa_end.png")//===//
var p1title1=new pSprite("//image.giccoo.com/projects/genki/img/part1title1_end.png")//===
//var p1title2=new pSprite("//image.giccoo.com/projects/genki/img/part1title2f.png")//====meika
...
var boloonY=3000//434+1107+627-300

function setPart1 () {
	main.addChild(part1)
	part1.addChild(p1pic1a,videoPart,p1title1,p1pic3,p1pic2,btnPlay,p1pic4,btnStop)//btnSongBG,btnSong



	btnPlay.y=btnStop.y=438+boloonY//==============改改改
	btnPlay.x=btnStop.x=2
	btnStop.alpha=0
	btnStop.interactive=true
	btnStop.tap=goBGM

	p1pic1a.y=653+boloonY-434//==============改改改
	p1pic2.y=boloonY-434//==============改改改

	//p1title2.y=-35

	p1pic3.pivot.set(258,258)
	p1pic3.position.set(320,494+26+boloonY)//==============改改改
	...
	p1pic4.alpha=.8
	p1pic4.y=boloonY//==============改改改
	TweenMax.to(p1pic4,1,{alpha:0,repeat:10000,yoyo:true})


	btnSong.y=1182+434+1107+627-300
	btnSongBG.y=1182+434+1107+627-300
	btnSong.x=201
...
var videoPartBG=new pSprite("//image.giccoo.com/projects/genki/img/video_part_bg3_end.png")
...
// function setPart2(){
// 	main.addChild(part2)
// 	part2.y=1372+690+434+1107+627-300
...
// 	part2_5.y=1688-300+690+260+434-50+1107+627-300
...
// function setPart3(){
// 	main.addChild(part3)
// 	part3.y=1688-300+690+260+434+400+1107+627-300
...
var p4title1=new pSprite("//image.giccoo.com/projects/genki/img/part4title1_end.png")
...
function setPart4(_list){
	main.addChild(part4)
	part4.y=1750//2980-300+690+260+434+400+1107+627-300
	part4.addChild(p4title1,p4light1,p4light2,p4title2)
	//p4t1.y=1040+155
	...
	var i,j
	for ( i = 0; i < 10; i++) {
			message(_list[i].message,_list[i].nickname,_list[i].like+100-i*10,_list[i].liked,_list[i].id,false)
	};
...
function setPart4c(_list){
	...
	boloonY=nowHeight+50+part4.y-200
	setBoloonY()

}

function setBoloonY(){
	console.log("setBoloonY",boloonY,p1pic1a.y)
	btnPlay.y=btnStop.y=438+boloonY//==============改改改
