...
var $_GET, ANIMATION_END_NAME, ANIMATION_END_NAMES, INDEX, Loader, SendNote, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, UpdateShare, UpdateShareContent, VENDORS, _loader, bindIMAGE, cdn, closeWaiting, closeallpop, css3Prefix, debug, defaultWords, global, hideShareWechat, i, isMM, isWechat, k, layzr, len, link, loadStart, loadWechatConfig, mTestElement, opendWaiting, qrcode, selectFiles, sending, tm, uploadImage;
...
bindIMAGE = function bindIMAGE() {
    return $(".pic_All").on("click", function (evt) {
        var html;
...
uploadImage = function uploadImage(self, next) {
