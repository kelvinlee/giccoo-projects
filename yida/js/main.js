...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, SendNote, Store, TRANSITION_END_NAME, TRANSITION_END_NAMES, UpdateShare, VENDORS, cdn, css3Prefix, debug, hideShareWechat, i, isMM, j, layzr, len, loadStart, mTestElement, qrcode, share, shareCall, shareOneToAll, shared, tm;
...
window.onload = function () {
    ...
    return $.get('http://api.giccoo.com/momo/config', {
        ...
        return mm.invoke('initConfig', config, function (resq) {
            ...
            isMM = true;
            UpdateShare();
            return Store.build && Store.build.updateFrom();
        });
    });
};
