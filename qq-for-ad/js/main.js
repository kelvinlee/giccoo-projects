...
},{key:"init",value:function e(){var t,i,n,r,o,a,s,l,u,c,d,p,h,g,m,f;return(t=new Spr(_CDN+"img/bg2.jpg")).width=this.opts.w,t.height=this.opts.h,(l=new Spr(_CDN+"img/huati.png")).y=this.opts.h-l.height,(u=new Spr(_CDN+"img/logo.png")).y=this.opts.h-u.height-.015*this.opts.h,a=new Container,s=new Spr(_CDN+"img/filecover.png"),(f=new Spr(_CDN+"img/ugc-title.png")).y=40,o=new Spr(_CDN+"img/ugc-content-".concat(main.carIndex+1,".png")),h=new Spr(_CDN+"img/ugc-content-over-".concat(main.carIndex+1,".png")),(p=new Text("".concat(main.nickname," "),{fontFamily:"Arial",fontSize:32,fontWeight:"normal",fill:7160354,letterSpacing:2,lineHeight:40})).x=122+(296-p.width)/2,p.y=f.y+(f.height-p.height)/2+6,o.y=f.y+f.height,h.y=o.y,h.visible=!1,m=(m=main.message).replace(/<br\/>/g,"\n"),// message.width = 500
(d=new Text("".concat(m," "),{fontFamily:"Arial",breakWords:!0,wordWrapWidth:505,wordWrap:!0,fontSize:20,fill:7160354,fontStyle:"normal",fontWeight:"normal",letterSpacing:0,lineHeight:28})).x=125,d.y=o.y+o.height-40,r=new Spr(_CDN+"img/share-title.png"),n=new Spr(_CDN+"img/btn-reload.png"),i=new Spr(_CDN+"img/btn-more.png"),console.log(d.height),r.y=d.y+140+20,n.y=r.y+r.height+10,n.x=120,i.y=r.y+r.height+10,i.x=n.x+n.width+20,r.interactive=!0,n.interactive=!0,i.interactive=!0,r.tap=this.share.bind(this),n.tap=function(){return window.location.reload()},i.tap=function(){return window.location.href="https://mactivity.lenovo.com.cn/activity/marketing/xyxs/wyy/index.html?pmf_source=P0000000982M0066"},(g=new Spr(_CDN+"img/qr.png")).y=r.y-r.height+63,g.visible=!1,c=new Spr(_CDN+"img/mark-".concat(main.yearName,".png")),"80"===main.yearName?c.y=this.opts.h-c.height:c.y=(this.opts.h-c.height)/2,a.addChild(s,f,h,o,p,d,r,n,i,g),// file.scale.set(0.8,0.8)
a.y=(this.opts.h-a.height)/2,a.y+a.height>l.y-.5*l.height?a.y-=.23*l.height:a.y-=.05*this.opts.h,console.log("Y:",a.y,a.y+a.height,l.y+.5*l.height),a.y<=10&&(a.y=10),this.stage.addChild(t,l,u,a,c),this.btnShare=r,this.btnReload=n,this.btnMore=i,this.contentimg=o,this.overimg=h,this.huati=l,this.qr=g,this.file=a,this.oldFileY=a.y}},{key:"share",value:function e(){return this.btnShare.visible=!1,this.btnReload.visible=!1,this.btnMore.visible=!1,this.huati.visible=!1,this.contentimg.visible=!1,this.qr.visible=!0,this.overimg.visible=!0,this.file.y=(this.opts.h-this.file.height)/2,main.share()}},{key:"shareDone",value:function e(){return this.btnShare.visible=!0,this.btnReload.visible=!0,this.btnMore.visible=!0,this.huati.visible=!0,this.contentimg.visible=!0,this.qr.visible=!1,this.overimg.visible=!1,this.file.y=this.oldFileY}}]),t}();return e.prototype.builded=!1,e.prototype.default={w:320,h:160,running:!0},e.prototype.started=!1,e.prototype.over=!1,e.prototype.online=!1,e.prototype.blocks=[],e.prototype.bottles=[],e.prototype.enemys=[],e.prototype.lights=[],e.prototype.dom={},e.prototype._progress=0,e.prototype.lineMoving=!1,e.prototype.startTime=null,e.prototype.loadNumber=0,e}.call(void 0),loadWechatConfig=function e(){var t,i,n;n=encodeURIComponent(window.location.href.split("#")[0]),(t=document.createElement("script")).src="//api.giccoo.com/api/config?url="+n,(i=document.getElementsByTagName("script")[0]).parentNode.insertBefore(t,i)},Container=PIXI.Container,ParticleContainer=PIXI.ParticleContainer,autoDetectRenderer=PIXI.autoDetectRenderer,loader=PIXI.loader,resources=PIXI.loader.resources,TextureCache=PIXI.utils.TextureCache,Texture=PIXI.Texture,Sprite=PIXI.Sprite,Graphics=PIXI.Graphics,resource=PIXI.loader.resources,Text=PIXI.Text,AnimatedSprite=PIXI.extras.AnimatedSprite,Spr=function e(t){return new Sprite(getTe(t))},getTe=function e(t){return resource[t].texture},getId=function e(t,i){return loader.resources[i].textures[t]},// for fix ios 8 less
null==Number.isInteger&&(Number.isInteger=function(e){return 0<=e}),IsPC=function e(){var t,i,n,r;for(n=navigator.userAgent,t=new Array("Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"),i=!0,r=0;r<t.length;){if(0<n.indexOf(t[r])){i=!1;break}r++}return i},Vue.component("player",{template:'<div class="player" :class="{play: playing, pause: !playing}" @click="change"> <div class="icon-play" :class="{play: playing, pause: !playing}"> <svg v-if="!icon" v-show="!playing" height="100%" version="1.1" viewBox="0 0 36 36" width="100%"><use class="ytp-svg-shadow" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#ytp-id-39"></use><path class="ytp-svg-fill" d="M 12,26 18.5,22 18.5,14 12,10 z M 18.5,22 25,18 25,18 18.5,14 z"></path></svg> <svg v-if="!icon" v-show="playing" height="100%" version="1.1" viewBox="0 0 36 36" width="100%"><use class="ytp-svg-shadow" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#ytp-id-40"></use><path class="ytp-svg-fill" d="M 12,26 16,26 16,10 12,10 z M 21,26 25,26 25,10 21,10 z"></path></svg> </div> <audio :src="src" :autoplay="autoplay" :preload="preload" :loop="loop"></audio> <img v-if="thumb" :src="thumb" /> <slot></slot> </div>',data:function e(){return{playing:!1,stoped:!1}},props:{name:{default:!1},src:{default:"./mp3/bgm.mp3"},thumb:{default:!1},autoplay:{default:!1},preload:{default:!1},loop:{default:!1},callback:{default:!1},icon:{default:!1}},methods:{play:function e(){var t;// @audio.load()
return t=this.$emit("play",this),this.playing=!0,this.audio.play()},pause:function e(){var t;return t=this.$emit("pause",this),this.audio.pause(),this.playing=!1},ended:function e(){return this.playing=!1},change:function e(){return this.playing?(this.audio.pause(),this.stoped=!0):(this.audio.play(),this.stoped=!1)}},
// computed:
mounted:function e(t){
// console.log @name
...
null==Number.isInteger&&(Number.isInteger=function(e){return 0<=e}),IsPC=function e(){var t,i,n,r;for(n=navigator.userAgent,t=new Array("Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"),i=!0,r=0;r<t.length;){if(0<n.indexOf(t[r])){i=!1;break}r++}return i},Container=PIXI.Container,ParticleContainer=PIXI.ParticleContainer,autoDetectRenderer=PIXI.autoDetectRenderer,loader=PIXI.loader,resources=PIXI.loader.resources,TextureCache=PIXI.utils.TextureCache,Texture=PIXI.Texture,Sprite=PIXI.Sprite,Graphics=PIXI.Graphics,resource=PIXI.loader.resources,Text=PIXI.Text,AnimatedSprite=PIXI.extras.AnimatedSprite,Spr=function e(t){return new Sprite(getTe(t))},getTe=function e(t){return resource[t].texture},getId=function e(t,i){return loader.resources[i].textures[t]},// for fix ios 8 less
...
// 		if n is ""
// 			@.type1Name = "行业"
methods:{openMenu:function e(t){return this.type===t?this.type=0:this.type=t},selectType:function e(t,i,n){return this["type"+t]===n?(this["type"+t]=0,this["type"+t+"Name"]=""):(this["type"+t]=n,this["type"+t+"Name"]=i),console.log(this.type1,this.type2,this.type3)},prev:function e(){return this.$children[0].prev()},next:function e(){return this.$children[0].next()},number:function e(t){},
// @.carIndex = n
send:function e(t){var i=this;return this.noteShow=!0,this.noteText=t,clearTimeout(this.noteTime),this.noteTime=setTimeout(function(){return i.noteShow=!1},2e3)},dateText:function e(t){var i;return console.log(t.replace(/-/g,"/")),(i=new Date(t.replace(/-/g,"/"))).getFullYear()+"年"+(i.getMonth()+1)+"月"+i.getDate()+"日"},goUGC:function e(){return this.lotteryShow=!0},sharePost:function e(t){// @.ugc = ugc.app.view.toDataURL()
