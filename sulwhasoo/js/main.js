...
sulwhasoo = (function() {
  ...
  class sulwhasoo {
    ...
    loadProgress() {
      var timein;
      return timein = setInterval(() => {
        this.progress += 3;
        if (this.progress >= this.maxProgress) {
          this.progress = this.maxProgress;
        }
        this.loadText.text = `Loading...${this.progress}%`;
    ...
    // page 1
    page1() {
      var bg, cloud, hand, i, k, l, p, point, product, productBorder, q, runHand, size, star, title, woman, xylist;
      this.Index = 1;
    ...
    // page 3
    page3build() {
      var btn, btnRun, cd, cdPointer, name, runCD, self, small, title, titleText;
      // unless lastName?
      //   return @.page4build()
      this.Index = 3;
      this.animation = true;
    ...
    page4build() {
      var ball, btn, btnRun, item, name, phone, runBall, self, small, title, titleText;
      // unless shareName?
      //   return @.page5build()
      this.Index = 4;
      this.animation = true;
    ...
    page5build() {
      var btn, i, icon, iconTimes, icons, k, light1, light2, light3, lightL, lightS, page5ShowStep1, page5ShowStep2, page5ShowStep3, product, productBG, productBGEnd, runSLlight, scaleX, self, step, title, titleLarge;
      this.Index = 5;
      this.animation = true;
      ...
      this.page5.touchstart = this.page5.click = (data) => {
    ...
    page6build() {
      var FixSize, i, icon, k, l, leftBtn, leftBtnEmpty, p, qrcode, rightBtn, rightBtnEmpty, runArrow, runUGC1BG, runUGC2Item, runUGC3BG, runUGC4BG, runUGC4Star, runUGC5Light, star, ugc1, ugc1BG, ugc1Icons, ugc2, ugc2BG, ugc2Item, ugc3, ugc3BG, ugc3Icons, ugc3Item, ugc4, ugc4BG, ugc4BG2, ugc4Stars, ugc5, ugc5BG, ugc5Item1, ugc5Item2, ugc5Item3;
      this.Index = 6;
      this.animation = true;
...
init = function() {
  ...
  return axios.get("//music.163.com/api/activity/sulwhasoo/userInfo?type=1").then((msg) => {
    var d, date;
    d = msg.data;
