...
t.velocity=new CANNON.Vec3(20*Math.random()-10,30*Math.random(),45*-Math.random())}}function onDocumentTouchMove(e){
//donElement
...
PIXI.loader.add(imageList).use(this.loaditem.bind(this)).load(this.build.bind(this)),this.default.MH=.65*this.opts.h}return _createClass(t,[{key:"loaditem",value:function e(){
...
},{key:"buildUGC",value:function e(t){var n=this,o;return this.opts.h<=900?(console.log("??"),page3.addChild(logo,logo_down),this.app.renderer.render(this.app.stage),main.callShare(this.app.view.toDataURL())):null!=this.U?(this.U.renderer.render(this.U.stage),main.callShare(this.U.view.toDataURL()),!1):(this.U=new PIXI.Application({width:640,height:900,transparent:!0,preserveDrawingBuffer:!0,forceCanvas:!0}),// document.getElementById("testUGC").appendChild @.U.view
// console.log @.U
// page3.visible = true
o=new PIXI.Sprite.fromImage(t),logo_down.y=900-logo_down.height-30,this.U.stage.addChild(o,logo,logo_down),o.texture.baseTexture.on("loaded",function(){return console.log("loaded"),900<o.height&&(o.y=-(o.height-900)/2/5*3),n.U.renderer.render(n.U.stage),main.callShare(n.U.view.toDataURL())}))}}]),t}();return e.prototype.builded=!1,e.prototype.default={w:320,h:160,running:!0},e.prototype.started=!1,e.prototype.over=!1,e.prototype.online=!1,e.prototype.blocks=[],e.prototype.bottles=[],e.prototype.enemys=[],e.prototype.lights=[],e.prototype.dom={},e.prototype._progress=0,e.prototype.lineMoving=!1,e.prototype.startTime=null,e.prototype.loadNumber=0,e}.call(void 0),_CDN=".",thudIndex=0,(SOUND={}).runRandomHit=function(){return SOUND["hit".concat(thudIndex+1)].play(),thudIndex=(thudIndex+1)%4},SOUND.hit1=new Howl({src:["".concat(_CDN,"/mp3/pig-1.mp3")]}),SOUND.hit2=new Howl({src:["".concat(_CDN,"/mp3/pig-2.mp3")]}),SOUND.hit3=new Howl({src:["".concat(_CDN,"/mp3/pig-3.mp3")]}),SOUND.hit4=new Howl({src:["".concat(_CDN,"/mp3/pig-4.mp3")]}),SOUND.gift=new Howl({src:["".concat(_CDN,"/mp3/gift.mp3")]}),SOUND.giftEnd=new Howl({src:["".concat(_CDN,"/mp3/han.mp3")],volume:.3}),SOUND.end=function(){return SOUND.giftEnd.play()},// setTimeout ->
// 	SOUND.bgm.play()
// ,500
