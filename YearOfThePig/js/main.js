...
//var pigMat=new THREE.MeshToonMaterial({map:pigmap,shininess:10,specular:0xff3388})//normalMap:pigmap,normalMapType:THREE.ObjectSpaceNormalMap
//var pigMat=new THREE.MeshStandardMaterial({map:pigmap,emissive:0xffffff,envMap:environment,emissiveIntensity:0.5,roughness:0.4,metalness:.5})
gift4.material=s}function addGift(){if(console.log("加个礼物"),7==level){for(var e=0;e<giftsNum[level];e++)setTimeout(addAGift,30*e);//removeJointConstraint();
renderer.domElement.removeEventListener("touchstart",onDocumentTouchStart,!1),renderer.domElement.removeEventListener("touchmove",onDocumentTouchMove,{passive:!1}),renderer.domElement.removeEventListener("touchend",onDocumentTouchEnd,!1),TweenMax.to(rootPointBody.position,2.2,{y:130,onComplete:moveCamera}),ifCanTouch=!1,SOUND.end(),main.gameOver()}else{for(var e=0;e<giftsNum[level];e++)setTimeout(addAGift,60*e);main.runGift()}removeJointConstraint()}function moveCamera(){scene.remove(objs.pig),setTimeout(pixiStart,1e3),TweenMax.to(camera.position,3,{y:25,ease:Power2.easeInOut,onUpdate:function e(t){camera.updateProjectionMatrix()}}),TweenMax.to(camera,3,{zoom:.8,ease:Power2.easeInOut,onUpdate:function e(t){camera.updateProjectionMatrix()},onComplete:endThree})}function endThree(){ifThreePlay=!1}function addAGift(){
// if(sound.isPlaying){
// 	sound.stop();
// }
// sound.play();
...
return ifFirsTime=!1,console.log("啦啦啦啦啦1111"),scene=new THREE.Scene,camera=new THREE.OrthographicCamera(window.innerWidth/window.innerHeight*80/-2,window.innerWidth/window.innerHeight*80/2,40,-40,.1,200),renderer=new THREE.WebGLRenderer({antialias:!0,alpha:!1,preserveDrawingBuffer:!0}),//抗锯齿
world=new CANNON.World,cannonDebugRenderer=new THREE.CannonDebugRenderer(scene,world),//===物理引擎辅助
raycaster=new THREE.Raycaster,mouse=new THREE.Vector2,eyeGroup=new THREE.Group,renderer.setClearColor(16774608),//设置背景颜色
...
loadingMods("http://image.giccoo.com/projects/YearOfThePig/mod/gift1.glb",["gift1"]),loadingMods("http://image.giccoo.com/projects/YearOfThePig/mod/gift2.glb",["gift2"]),loadingMods("http://image.giccoo.com/projects/YearOfThePig/mod/gift3.glb",["gift3"]),loadingMods("http://image.giccoo.com/projects/YearOfThePig/mod/gift4.glb",["gift4"]),//render()
//animate()//===动画
...
function clickFunc(){renderer.domElement.addEventListener("touchstart",onDocumentTouchStart,!1),renderer.domElement.addEventListener("touchmove",onDocumentTouchMove,{passive:!1}),renderer.domElement.addEventListener("touchend",onDocumentTouchEnd,!1)}function onDocumentTouchStart(e){if(ifCanTouch&&(e.preventDefault(),mouse.x=e.touches[0].clientX/window.innerWidth*2-1,mouse.y=-e.touches[0].clientY/window.innerHeight*2+1,//donElement
...
t.velocity=new CANNON.Vec3(20*Math.random()-10,30*Math.random(),45*-Math.random())}}function onDocumentTouchMove(e){if(ifCanTouch&&(e.preventDefault(),mouse.x=e.touches[0].clientX/window.innerWidth*2-1,mouse.y=-e.touches[0].clientY/window.innerHeight*2+1,mouseConstraint)){var t=e.touches[0].clientX-lastX,n=e.touches[0].clientY-lastY,o=t<0?-1:1,i=n<0?-1:1;//console.log(pickingPlane)
...
function loadingMods(e,n,o){modNum++;var t=new THREE.GLTFLoader;console.log("loader:",t),t.load(e,function(e){
...
//var pigMat=new THREE.MeshStandardMaterial({map:pigmap,emissive:0xffffff,envMap:environment,emissiveIntensity:0.5,roughness:0.4,metalness:.5})
objs.pig.material=d,//TweenMax.set(pig.scale,{x:.105,y:.105,z:.095})
...
if(this.loadNumber++,loading.updateImgs(parseInt(this.loadNumber/imageList.length*100),2),this.loadNumber===imageList.length)return buildUGC.bind(this).call(),this.opts.callback()}// @.init()
// console.log "aa"
...
// 	SOUND.bgm.play()
// ,500
loadWechatConfig=function e(){var t,n,o;o=encodeURIComponent(window.location.href.split("#")[0]),(t=document.createElement("script")).src="//api.giccoo.com/api/config?url="+o,(n=document.getElementsByTagName("script")[0]).parentNode.insertBefore(t,n)},IsPC=function e(){var t,n,o,i;for(o=navigator.userAgent,t=new Array("Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"),n=!0,i=0;i<t.length;){if(0<o.indexOf(t[i])){n=!1;break}i++}return n},Container=PIXI.Container,ParticleContainer=PIXI.ParticleContainer,autoDetectRenderer=PIXI.autoDetectRenderer,loader=PIXI.loader,resources=PIXI.loader.resources,TextureCache=PIXI.utils.TextureCache,Texture=PIXI.Texture,Sprite=PIXI.Sprite,Graphics=PIXI.Graphics,resource=PIXI.loader.resources,Text=PIXI.Text,AnimatedSprite=PIXI.extras.AnimatedSprite,Spr=function e(t){return new Sprite(getTe(t))},getTe=function e(t){return resource[t].texture},getId=function e(t,n){return loader.resources[n].textures[t]},// for fix ios 8 less
...
TrueW=640,TrueH=1138,imageurl="//api.giccoo.com/api/upload/image64/",apiUrl="//api.giccoo.com/YearOfThePig",// apiLink = "//localhost:3000/"
...
console.log("share href:",t),CloudMusic.sharePic({picUrl:t,text:o,link:n})},// "//cdnjs.cloudflare.com/ajax/libs/pixi.js/4.8.5/pixi.min.js"
loadList=["//cdnjs.cloudflare.com/ajax/libs/gsap/2.0.2/TweenMax.min.js","//cdnjs.cloudflare.com/ajax/libs/axios/0.18.0/axios.min.js","//cdnjs.cloudflare.com/ajax/libs/three.js/101/three.min.js","//image.giccoo.com/projects/libs/js/splitting.min.js","//cdnjs.cloudflare.com/ajax/libs/dat-gui/0.7.5/dat.gui.min.js","//cdnjs.cloudflare.com/ajax/libs/cannon.js/0.6.2/cannon.min.js","//cdnjs.cloudflare.com/ajax/libs/stats.js/r16/Stats.min.js","//cdnjs.cloudflare.com/ajax/libs/howler/2.0.15/howler.core.min.js","//image.giccoo.com/projects/genki/js/music-jssdk-1.0.5.js","//image.giccoo.com/projects/genki/js/ntes.id.js","//image.giccoo.com/projects/YearOfThePig/js/THREE.MeshLine.js","js/libs.js?v=1"],window.onload=function(){var e,t,n;return TrueH=document.documentElement.clientHeight,TrueW=document.documentElement.clientWidth,e=0,-1<window.navigator.userAgent.indexOf("NeteaseMusic")?(sys="NeteaseMusic",n={name:"YearOfThePig",title:"新年福袋被偷走了，你的福贴还在里面呢! 快点抢回来吧~",subTitle:"可恶的小猪你别跑,把我的福袋还回来!!!",text:"",picUrl:"http://m.giccoo.com/YearOfThePig/img/ico.jpg",link:"http://m.giccoo.com/YearOfThePig/"},CloudMusic.setShareData(n)):(loadWechatConfig(),wx.ready(function(){var e;return e={title:"新年福袋被偷走了，你的福贴还在里面呢! 快点抢回来吧~",desc:"可恶的小猪你别跑,把我的福袋还回来!!!",link:"http://m.giccoo.com/YearOfThePig/",imgUrl:"http://m.giccoo.com/YearOfThePig/img/ico.jpg",success:function e(){},
// alert "success"
