...
function clickFunc(){renderer.domElement.addEventListener("touchstart",onDocumentTouchStart,!1),renderer.domElement.addEventListener("touchmove",onDocumentTouchMove,{passive:!1}),renderer.domElement.addEventListener("touchend",onDocumentTouchEnd,!1)}function onDocumentTouchStart(e){if(
//if(!ifCanTouch) return;
e.preventDefault(),mouse.x=e.touches[0].clientX/window.innerWidth*2-1,mouse.y=-e.touches[0].clientY/window.innerHeight*2+1,//donElement
...
if(
//if(!ifCanTouch) return;
e.preventDefault(),mouse.x=e.touches[0].clientX/window.innerWidth*2-1,mouse.y=-e.touches[0].clientY/window.innerHeight*2+1,mouseConstraint){var t=e.touches[0].clientX-lastX,n=e.touches[0].clientY-lastY,o=t<0?-1:1,i=n<0?-1:1;//console.log(pickingPlane)
